...
from (
    ...
    from (
		...
		union all
			select substring(col_startpage_card_id, 90, 18) as col_card_id, 'SHOW' as col_action 
			from android.tb_card_show
		...
		union all
			select substring(col_startpage_card_id, 109, 18) as col_card_id, 'SHOW' as col_action 
			from android.tb_card_show
