select e.p_date, e.col_uid, e.col_udid, e.col_version, e.col_feed_card_num, e.col_content_card_num, case when e.col_udid is not null and e.col_feed_clicks is null then 0L else e.col_feed_clicks end, e.col_feed_impressions, case when e.col_udid is not null and e.col_startpage_distribution is null then 0L else e.col_startpage_distribution end, case when e.col_udid is not null and e.col_startpage_detail_distribution is null then 0L else e.col_startpage_detail_distribution end, case when e.col_udid is not null and e.col_publisher_distribution is null then 0L else e.col_publisher_distribution end, case when e.col_udid is not null and e.col_publisher_detail_distribution is null then 0L else e.col_publisher_detail_distribution end, case when e.col_udid is not null and e.col_subset_distribution is null then 0L else e.col_subset_distribution end, case when e.col_udid is not null and e.col_subset_detail_distribution is null then 0L else e.col_subset_detail_distribution end, f.col_launches, e.col_new_user
from (
	select c.p_date, c.col_uid, c.col_udid, c.col_version, c.col_feed_card_num, c.col_content_card_num, d.col_feed_clicks, c.col_feed_impressions, d.col_startpage_distribution, d.col_startpage_detail_distribution, d.col_publisher_distribution, d.col_publisher_detail_distribution, d.col_subset_distribution, d.col_subset_detail_distribution, c.col_new_user
	from (
